...
public interface IGeraet extends Remote {
    ...
    ArrayList<IAusleiher> getHistorie() throws RemoteException;
    ...
    ArrayList<IAusleiher> getReservierungsliste() throws RemoteException;
    void setHistorie(ArrayList<IAusleiher> historie) throws RemoteException;
    ...
    void setReservierungsliste(ArrayList<IAusleiher> reservierungsliste) throws RemoteException;
