...
public interface IRollenverwaltung extends Remote {
    ...
    ArrayList getGaeste() throws RemoteException;
    ArrayList getMitglieder() throws RemoteException;
    ArrayList getMitarbeiter() throws RemoteException;
    ArrayList getVorsitze() throws RemoteException;
    ArrayList getMahnungen() throws RemoteException;
    long getIdCounter() throws RemoteException;
    String getMitgliedsNamen(String MitgliedsID) throws Exception;
